import type { MenuItemConfig } from '..'
...
export const timezones: MenuItemConfig[] = [
  ...
  { label: '(GMT+12:00) Nauru Time (Pacific/Nauru)', value: 'Pacific/Nauru' },
  {
  ...
  {
    label: '(GMT+11:00) Ponape Time (Pacific/Ponape)',
  ...
  { label: '(GMT+10:00) Chuuk Time (Pacific/Truk)', value: 'Pacific/Truk' },
  {
  ...
  { label: '(GMT+09:00) East Timor Time (Asia/Dili)', value: 'Asia/Dili' },
  {
  ...
  { label: '(GMT+09:00) Palau Time (Pacific/Palau)', value: 'Pacific/Palau' },
  {
    label:
  ...
  { label: '(GMT+08:00) Malaysia Time (Asia/Kuching)', value: 'Asia/Kuching' },
  {
  ...
  { label: '(GMT+07:00) Indochina Time (Asia/Bangkok)', value: 'Asia/Bangkok' },
  {
  ...
  { label: '(GMT+07:00) Hovd Standard Time (Asia/Hovd)', value: 'Asia/Hovd' },
  {
  ...
  { label: '(GMT+06:30) Myanmar Time (Asia/Rangoon)', value: 'Asia/Rangoon' },
  {
  ...
  { label: '(GMT+06:00) Omsk Standard Time (Asia/Omsk)', value: 'Asia/Omsk' },
  { label: '(GMT+06:00) Bhutan Time (Asia/Thimphu)', value: 'Asia/Thimphu' },
  {
  ...
  { label: '(GMT+05:45) Nepal Time (Asia/Kathmandu)', value: 'Asia/Kathmandu' },
  {
  ...
  { label: '(GMT+05:00) West Kazakhstan Time (Asia/Oral)', value: 'Asia/Oral' },
  {
  ...
  { label: '(GMT+04:30) Afghanistan Time (Asia/Kabul)', value: 'Asia/Kabul' },
  {
    label: '(GMT+04:00) Azerbaijan Standard Time (Asia/Baku)',
    value: 'Asia/Baku',
  },
  { label: '(GMT+04:00) Gulf Standard Time (Asia/Dubai)', value: 'Asia/Dubai' },
  {
  ...
  { label: '(GMT+04:00) Seychelles Time (Indian/Mahe)', value: 'Indian/Mahe' },
  {
  ...
  {
    label: '(GMT+01:00) Western European Summer Time (Atlantic/Faeroe)',
  ...
  { label: '(GMT+00:00) Greenwich Mean Time (GMT)', value: 'GMT' },
  {
    label: '(GMT-01:00) West Greenland Summer Time (America/Godthab)',
  ...
  {
    label: '(GMT-03:00) Argentina Standard Time (America/Catamarca)',
  ...
  {
    label: '(GMT-03:00) Argentina Standard Time (America/Cordoba)',
  ...
  {
    label: '(GMT-03:00) Argentina Standard Time (America/Jujuy)',
    value: 'America/Jujuy',
  },
  {
  ...
  {
    label: '(GMT-03:00) Argentina Standard Time (America/Mendoza)',
  ...
  {
    label: '(GMT-04:00) Paraguay Standard Time (America/Asuncion)',
  ...
  {
    label: '(GMT-04:00) Eastern Daylight Time (America/Louisville)',
  ...
  {
    label: '(GMT-05:00) Mountain Daylight Time (America/Ojinaga)',
  ...
  {
    label: '(GMT-06:00) Mexican Pacific Standard Time (America/Chihuahua)',
  ...
  {
    label: '(GMT-06:00) Easter Island Standard Time (Pacific/Easter)',
  ...
  { label: '(GMT-07:00) Yukon Time (America/Dawson)', value: 'America/Dawson' },
  {
  ...
  { label: '(GMT-11:00) Niue Time (Pacific/Niue)', value: 'Pacific/Niue' },
  {
